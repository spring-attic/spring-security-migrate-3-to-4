...
* The {spring-security-docs-url}nsa-form-logout-logout-url[form-login@username-parameter] attribute default value changed from "/j_spring_security_logout" to "/logout".
